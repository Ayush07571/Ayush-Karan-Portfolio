...
export default function About() {
  return (
    <section id="about" className="relative mx-auto max-w-6xl px-4 sm:px-6 py-28 z-10">
      <Reveal>
      ...
      <div className="mt-10 grid grid-cols-1 md:grid-cols-12 gap-5">
        ...
        <Reveal delay={0.08} className="md:col-span-8 flex">
          <div className="glass-panel-interactive w-full rounded-2xl p-7 flex flex-col justify-between relative overflow-hidden group">
            <div className="absolute top-0 right-0 h-32 w-32 bg-accent-purple/10 blur-3xl pointer-events-none rounded-full" />
            
            <div>
              <div className="flex items-center justify-between">
                <span className="inline-flex items-center gap-1.5 rounded-full border border-line bg-panel-light px-3 py-1 font-mono text-xs text-accent-purple">
                  <GraduationCap className="h-3.5 w-3.5" />
                  B.Tech CSE &bull; Cloud Computing &amp; Automation &apos;26
                </span>
                <span className="font-mono text-xs text-muted">VIT Bhopal University</span>
              </div>

              <p className="mt-6 text-lg sm:text-xl leading-relaxed text-ivory font-normal">
            ...
            <div className="mt-8 flex flex-wrap gap-2 pt-4 border-t border-line">
        ...
        <Reveal delay={0.14} className="md:col-span-4 flex">
          <div className="glass-panel-interactive w-full rounded-2xl p-6 flex flex-col items-center justify-center text-center relative overflow-hidden group">
        ...
        <Reveal delay={0.2} className="md:col-span-6 flex">
          <div className="glass-panel-interactive w-full rounded-2xl p-6 flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between">
          ...
          <div className="glass-panel-interactive w-full rounded-2xl p-6 flex flex-col justify-between">
            <div>
              ...
              <div className="mt-5 grid grid-cols-2 gap-3">
                <div className="rounded-xl border border-line bg-panel-light/70 p-4">
                  <p className="font-mono text-2xl font-extrabold text-accent-purple">01</p>
                ...
                <div className="rounded-xl border border-line bg-panel-light/70 p-4">
                  <p className="font-mono text-2xl font-extrabold text-accent-cyan">02</p>
                ...
                <div className="rounded-xl border border-line bg-panel-light/70 p-4">
                  <p className="font-mono text-2xl font-extrabold text-accent-emerald">03</p>
                ...
                <div className="rounded-xl border border-line bg-panel-light/70 p-4">
                  <p className="font-mono text-2xl font-extrabold text-accent-amber">04</p>
